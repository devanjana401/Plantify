    ...
    <div>
      ...
      <Container className="mt-5">
                ...
                <tr key={item.id}>
                  ...
                  <td>
                    <div className="d-flex align-items-center gap-2">
                      <Button variant="outline-secondary" size="sm" onClick={() => dispatch(decreaseQty(item.id))}>−</Button>
                      <span>{item.qty}</span>
                      <Button variant="outline-secondary" size="sm" onClick={() => dispatch(increaseQty(item.id))}>+</Button>
                    </div>
                  </td>
        ...
        <Card className="mt-4 p-3 shadow-sm" style={{ maxWidth: "400px" }}>
          ...
          <p>
            <strong>Total Amount:</strong> <span className="text-success fw-bold">₹{totalAmount}</span>
          </p>
          <Button variant="success" className="w-100" onClick={() => navigate("/checkout")}>
            Proceed to Checkout
          </Button>
        </Card>
      </Container>
